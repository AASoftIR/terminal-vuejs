<template>
    <div v-if="showIf" @animationend="destroyIntro" id="container" class="netflixintro" :class="{ 'fade-out': !showIntro }">
        ...
        <audio ref="introSound" src="/assets/sound/intro.mp3" autoplay></audio>
</template>
